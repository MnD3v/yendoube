...
const Galery = () => {
    ...
    const images = [{ description: 'Cadeaux de Noel a Tantigou/Peulh', image: 'https://borgenproject.org/wp-content/uploads/10-Facts-about-Orphans-in-South-Africa-1.jpg' }, { description: 'Scolariser les démunis de Lotogou', image: 'https://borgenproject.org/wp-content/uploads/15734662856_8de7a6424f_o-300x200.jpg' }, { description: 'Trouver des familles pour les orphelins', image: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQ6RIVCKQNUIqJwTfgK5Pll93xsSNG0b4VZBoJxJ11YSKK4DlsvF4iAl3wZlw82JNcRzY0&usqp=CAU" }, { description: 'Decompte des orphelins de yenyane', image: 'https://earthtimes.org/cdn/shop/articles/world-day-war-orphans_6113.jpg?v=1684443180' }, { description: 'Apprendre a dessiner aux enfants de Nioukrouma', image: 'https://pmedia.launchgood.com/97687/support_orphans_across_zanzibar_today_Cover1-700x525.JPG' }]
    return (
