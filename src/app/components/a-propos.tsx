                ...
                <div className=' flex flex-wrap m-8  justify-center gap-6'>
                    ...
                    <div className='max-w-96 flex flex-col'>
                        <div className='flex flex-col gap-3'>
                            <h3 className='text-lg md:text-2xl font-roboto text-zinc-700 underline underline-offset-8 '>Fondateur</h3>
                            <h2 className='text-start font-roboto text-xl md:text-3xl'>ALEDE Kokou Joseph</h2>
                            <p className=''>Révérend ALEDE est un pasteur, enseignant et directeur d'école passionné par la justice sociale. Son engagement envers les veuves, les orphelins et les personnes handicapées découle de sa profonde foi et de son expérience éducative. Il inspire et dirige notre organisation avec compassion, visant à bâtir une communauté plus juste et solidaire.</p>

                            <div className='w-full font-roboto text-center inline-block mt-2 border-2 px-4 py-2 bg-black/10 content-center gap-1'>
