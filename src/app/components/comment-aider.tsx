    ...
    return (
        <div className='flex flex-col items-center bg-zinc-200 pt-11'>
            ...
            <div className='flex flex-wrap items-center justify-center m-6'>
                <img src="https://www.dralicenicholls.com/wp-content/uploads/2021/12/How-to-help-someone-in-Autistic-Burnout-768x432.png" alt="" className='h-[19rem] w-[22rem] md:h-[29rem] md:w-[32rem]  object-cover' />
